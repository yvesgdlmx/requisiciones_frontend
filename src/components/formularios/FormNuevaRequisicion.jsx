      ...
      <div className="bg-white shadow-xl rounded-2xl p-8 max-w-5xl mx-auto border border-gray-200">
        ...
        <section className="mb-8">
          ...
          <button
            ...
            className="inline-flex items-center px-5 py-3 border border-dashed border-blue-500 rounded-md text-blue-500 hover:bg-blue-50 transition-colors duration-200 mb-4"
          >
            <svg
